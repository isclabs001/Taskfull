...
class UICommon
{
    ...
    static internal func CreateGradientLayer(parrentView : UIView, startColor : UIColor, endColor : UIColor) -> CAGradientLayer
    {
        // グラデーションレイヤーを作成
    ...
    static internal func IsGradation(startColor : UIColor?, endColor : UIColor?) -> Bool
    {
        // 開始色が設定されている場合
